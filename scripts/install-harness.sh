...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/QDaed/harness-experimental/main/scripts/install-harness.sh | bash -s -- --yes
  curl -fsSL https://raw.githubusercontent.com/QDaed/harness-experimental/main/scripts/install-harness.sh | bash -s -- --merge --yes
  curl -fsSL https://raw.githubusercontent.com/QDaed/harness-experimental/main/scripts/install-harness.sh | bash -s -- --merge --refresh-agent-shim --yes
EOF
}
...
SOURCE_ROOT=""
SOURCE_MODE="remote"
SOURCE_BASE_URL="${HARNESS_SOURCE_BASE_URL:-https://raw.githubusercontent.com/QDaed/harness-experimental/main}"
...
if [ -z "$CLI_BASE_URL" ]; then
  CLI_BASE_URL="https://github.com/QDaed/harness-experimental/releases/latest/download"
fi
